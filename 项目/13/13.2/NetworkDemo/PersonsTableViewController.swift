...
class PersonsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = persons?[indexPath.row]["stuName"]
        cell.detailTextLabel?.text = persons?[indexPath.row]["stuNo"]

        if let imagePath = persons?[indexPath.row]["imagePath"] {
